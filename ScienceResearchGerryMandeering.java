 ...
 *
 */
public class ScienceResearchGerryMandeering {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to the County redistricting program!!!" );
		
		System.out.print( "Please enter the name of county you would like to redistrict: " );
